...
> {
  ...
  constructor(
    @inject('datasources.mongoodb') dataSource: MongoodbDataSource, @repository.getter('ProductoRepository') protected productoRepositoryGetter: Getter<ProductoRepository>,
  ) {
